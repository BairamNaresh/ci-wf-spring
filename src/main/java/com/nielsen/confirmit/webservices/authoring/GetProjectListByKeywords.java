 ...
 *         &lt;element name="keywords" type="{http://firmglobal.com/Confirmit/webservices/}ArrayOfString1" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetProjectListByKeywords")
public class GetProjectListByKeywords {
    ...
    protected int topN;
    protected ArrayOfString1 keywords;
     ...
     *     
     */
    public ArrayOfString1 getKeywords() {
        return keywords;
    }
     ...
     *     
     */
    public void setKeywords(ArrayOfString1 value) {
        this.keywords = value;
    }
